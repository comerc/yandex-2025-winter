...
1.  **Плоские массивы (Flat Arrays)**:
    - Все переменные хранятся в локальных переменных без дополнительных структур.

2.  **Ручной инлайнинг и zero-allocation**:
    - Все вычисления реализованы без создания промежуточных объектов.
    - Цикл по делителям оптимизирован для минимальных операций.
